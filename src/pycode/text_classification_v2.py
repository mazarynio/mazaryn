...
def prepare_dataset(tokenized_data, labels, batch_size=16):
...
def fine_tune_model(train_dataset, test_dataset, num_labels, epochs=3, batch_size=16):
    model = TFDebertaV2ForSequenceClassification.from_pretrained('microsoft/deberta-v3-large', num_labels=num_labels)
