defmodule Mazaryn.Chats.Chat do
  ...
  @fields ~w(id user_id recipient_id body media bot date_created date_updated data)a
  ...
  @doc false
  def erl_changeset(
        {:chat, _id, _user_id, _recipient_id, _body, _media, _bot, _date_created, _date_updated,
         _data} = record
      ) do
