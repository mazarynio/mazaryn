defmodule Mazaryn.Schema.Ads do
  ...
  def erl_changeset(
        {:ads, id, ai_ads_id, business_account_id, campaign_id, date_created, date_updated,
         target_audience, budget, schedule, placement, performance_metrics, a_b_testing,
         dynamic_content, interactive_elements, augmented_reality_features, shoppable_features,
         compliance_check, eco_friendly_badge, localization, accessibility_features,
         chatbot_integration, user_generated_content, social_proof_elements,
         sequential_storytelling_id, context_aware_adaptation, voice_assistant_integration,
         blockchain_verification, neuroscience_tested, virtual_reality_components,
         voice_activated_elements, biometric_response_tracking, iot_integration,
         blockchain_verified_metrics, quantum_resistant_encryption, neurofeedback_optimized,
         emotional_ai_integration, cultural_sensitivity_score, language_localization,
         continuous_learning_adaptation, cross_reality_experience, metaverse_ready,
         microinteractions, privacy_preserving_targeting, adaptive_streaming_quality,
         haptic_feedback_patterns, scent_marketing_integration, subconscious_priming_elements,
         ambient_advertising_features, cognitive_bias_leveraging, sensory_branding_elements,
         temporal_marketing_adaptation, energy_efficient_display, attention_economy_metrics,
         digital_scarcity_elements, choice_architecture_design, psychographic_resonance_score,
         subliminal_optimization, data, user_id, content, ad_type}
      ) do
    %__MODULE__{}
    |> change(%{
      id: id,
