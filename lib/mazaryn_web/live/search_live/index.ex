defmodule MazarynWeb.SearchLive.Index do
  ...
  def mount(_params, %{"user_id" => email} = _session, socket) do
    ...
    found_users = [
      %Account.User{
        avatar_url:
          "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0f/Zoe_Saldana_by_Gage_Skidmore_2.jpg/440px-Zoe_Saldana_by_Gage_Skidmore_2.jpg",
        blocked: [],
        country: nil,
        date_created: nil,
        date_updated: nil,
        ...
        posts: ["e4a22767-368f-48b9-a4d2-ddeea8fc0a0f", "f0d08917-395f-416a-9e9f-d4b44023b34c"],
        private: false,
        saved_posts: [],
        username: "foobar"
      },
