                ...
                <div class="flex justify-center items-center">
                    <ul>
                        <li class="flex align-center items-center mx-2 mb-7">
                            <%= live_redirect to: Routes.live_path(@socket, MazarynWeb.HomeLive.Home), replace: false, class: "group flex align-center items-start text-xl text-gray-500 font-semibold hover:text-blue-500" do %>
                                <i>
                        ...
                        <li class="flex align-center items-center mx-2 mb-7">
                            <a href="index.html" class="group flex items-start text-xl text-gray-500 font-semibold hover:text-blue-500 ">
                                ...
                                <div class="text-[#CFD0DD] leading-6 group-hover:text-[#4385F5]">Chat</div>
                            </a>
                        </li>

                        <li class="flex align-center items-center mx-2 mb-7">
                            <a href="index.html" class="group flex items-start text-xl text-gray-500 font-semibold hover:text-blue-500">
                                <i><%= Heroicons.icon("users", class: "h-6 w-5 mr-3.5 fill-[#CFD0DD] group-hover:fill-[#4385F5]") %></i>
                                <div class="leading-6 text-[#CFD0DD] group-hover:text-[#4385F5]">Group</div>
                            </a>
                        </li>
                ...
                <div class="flex justify-center items-center">
                    <ul>
                        <li class="flex align-center items-center group mx-2 mb-7">
                            <%= live_patch to: Routes.live_path(@socket, MazarynWeb.HomeLive.Home), replace: false, class: "group flex items-start text-xl text-gray-500 font-semibold group-hover:text-blue-500" do %>
                                <i>
                                    <svg class="h-6 w-5 mr-3.5 fill-[#CFD0DD] group-hover:fill-[#4385F5]" width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path class="fill-[#CFD0DD] group-hover:fill-[#4385F5]" d="M18.75 8.375V6.5C18.75 5.80961 18.1903 5.25 17.5 5.25H3.75C3.06063 5.25 2.5 4.68937 2.5 4C2.5 3.31063 3.06063 2.75 3.75 2.75H17.5C18.1903 2.75 18.75 2.19031 18.75 1.5C18.75 0.809687 18.1903 0.25 17.5 0.25H3.75C1.68211 0.25 0 1.93215 0 4V5.25V15.25C0 16.6307 1.11937 17.75 2.5 17.75H17.5C18.1903 17.75 18.75 17.1904 18.75 16.5V14.625C19.4403 14.625 20 14.0654 20 13.375V9.625C20 8.93461 19.4403 8.375 18.75 8.375ZM16.875 12.75C16.1847 12.75 15.625 12.1904 15.625 11.5C15.625 10.8096 16.1847 10.25 16.875 10.25C17.5653 10.25 18.125 10.8096 18.125 11.5C18.125 12.1904 17.5653 12.75 16.875 12.75Z" />
                                    </svg>
                                </i>
                                <div  class="leading-6 text-[#CFD0DD] group-hover:text-[#4385F5]">Wallet</div>
                            <% end %>
                        </li>

                        <li class="flex align-center items-center mx-2 mb-7">
                            <a href="index.html" class="group flex items-center text-xl text-gray-500 font-semibold hover:text-blue-500">
                                <i>
                                    <svg class="h-5 w-5 mr-3.5 fill-[#CFD0DD] group-hover:fill-[#4385F5]" width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path class="fill-[#CFD0DD] group-hover:fill-[#4385F5]" d="M15 7H16V18H0V7H1V5C1 2.24 3.24 -2.23031e-07 6 -2.23031e-07C6.71 -2.23031e-07 7.39 0.15 8 0.42C8.6301 0.142126 9.31135 -0.000934361 10 -2.23031e-07C12.76 -2.23031e-07 15 2.24 15 5V7ZM3 5V7H5V5C5 3.87 5.39 2.84 6.02 2H6C4.35 2 3 3.35 3 5ZM13 7V5C13 3.35 11.65 2 10 2H9.98C10.6376 2.86228 10.9957 3.91562 11 5V7H13ZM8 2.78C7.39 3.33 7 4.12 7 5V7H9V5C9 4.12 8.61 3.33 8 2.78Z" />
                                    </svg>
                                </i>
                                <div  class="leading-6 text-[#CFD0DD] group-hover:text-[#4385F5]">My Products</div>
                            </a>
                        </li>

                        <li class="flex align-center items-center mx-2 group">
                            <%= live_redirect to: Routes.live_path(@socket, MazarynWeb.UserLive.Profile,  @user.username), replace: false, class: "group flex items-center text-xl text-[#CFD0DD] font-semibold" do %>
                                ...
                                <div class="leading-6 text-[#CFD0DD] group-hover:text-[#4385F5]">
                                    @<%= @user.username %>
                                </div>
                            <% end %>
                        </li>
                    ...
                    <ul>
                        ...
                        <li class="flex align-center items-center  group mx-2 ">
                            <a href="index.html" class="group flex items-start text-xl text-gray-500 font-semibold group-hover:text-blue-500">
                                ...
                                <div  class="leading-6 text-[#CFD0DD] group-hover:text-[#4385F5]">Pages</div>
                            </a>
                        </li>
                    </ul>
                </div>
