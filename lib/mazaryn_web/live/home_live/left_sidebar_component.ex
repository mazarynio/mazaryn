                    ...
                    <ul>
                        <li class="flex align-center items-center mx-2 mb-7">
                            <%= live_redirect to: Routes.live_path(@socket, MazarynWeb.HomeLive.Home), replace: false, class: "group flex align-center items-start text-xl text-gray-500 font-semibold hover:text-blue-500" do %>
                                ...
                                <div class="text-[#60616D] leading-6 group-hover:text-[#4385F5]">Home</div>
                            <% end %>
                        </li>
                        <li class="flex align-center items-center mx-2 mb-7">
                            <a href="index.html" class="group flex items-start text-xl text-gray-500 font-semibold hover:text-blue-500 ">
                                ...
                                <div class="text-[#60616D] leading-6 group-hover:text-[#4385F5]">Chat</div>
                            </a>
                        </li>

                        <li class="flex align-center items-center mx-2 mb-7">
                            <a href="index.html" class="group flex items-start text-xl text-gray-500 font-semibold hover:text-blue-500">
                                <i><%= Heroicons.icon("users", class: "h-6 w-5 mr-3.5 fill-[#60616D] group-hover:fill-[#4385F5]") %></i>
                                <div class="leading-6 text-[#60616D] group-hover:text-[#4385F5]">Group</div>
                            </a>
                        </li>
                    ...
                    <ul>
                        ...
                        <li class="flex align-center items-center mx-2 mb-7">
                            <a href="index.html" class="group flex items-center text-xl text-gray-500 font-semibold hover:text-blue-500">
                                <i>
                                    <svg class="h-5 w-5 mr-3.5 fill-[#60616D] group-hover:fill-[#4385F5]" width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path class="fill-[#60616D] group-hover:fill-[#4385F5]" d="M15 7H16V18H0V7H1V5C1 2.24 3.24 -2.23031e-07 6 -2.23031e-07C6.71 -2.23031e-07 7.39 0.15 8 0.42C8.6301 0.142126 9.31135 -0.000934361 10 -2.23031e-07C12.76 -2.23031e-07 15 2.24 15 5V7ZM3 5V7H5V5C5 3.87 5.39 2.84 6.02 2H6C4.35 2 3 3.35 3 5ZM13 7V5C13 3.35 11.65 2 10 2H9.98C10.6376 2.86228 10.9957 3.91562 11 5V7H13ZM8 2.78C7.39 3.33 7 4.12 7 5V7H9V5C9 4.12 8.61 3.33 8 2.78Z" />
                                    </svg>
                                </i>
                                <div  class="leading-6 text-[#60616D] group-hover:text-[#4385F5]">My Products</div>
                            </a>
                        </li>

                        <li class="flex align-center items-center mx-2 group">
                            <%= live_redirect to: Routes.live_path(@socket, MazarynWeb.UserLive.Profile,  @user.username), replace: false, class: "group flex items-center text-xl text-[#60616D] font-semibold" do %>
