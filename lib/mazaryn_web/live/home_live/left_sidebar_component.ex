    ...
    <div class="w-full bg-white white:bg-gray-800 shadow p-4 rounded-xl border">
      <div class="flex justify-between align-center items-center py-5">
        <div class="flex justify-center items-center">
            <ul class="">
                <%= live_patch to: Routes.live_path(@socket, MazarynWeb.HomeLive.Index), replace: false, class: "flex align-center items-center text-l px-2 py-4 text-gray-500 font-semibold hover:text-blue-500" do %>
